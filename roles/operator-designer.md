...
- 已列出 **参考实现**（例如 vLLM、TensorRT-LLM、SGLang、FlashAttention、FlashInfer、Triton、deepseek-ai/DeepGEMM 等中的具体子路径或模块名，便于 coder 检索），无则注明「无公开近似实现」
...
- Reference implementations: [repos + paths, e.g. vLLM/…, TRT-LLM/…, sglang/…, flash-attention/…, flashinfer/…, triton/…, deepseek-ai/…]
...
- Primary path: [cuBLAS / cuBLASLt / CUTLASS / cuDNN / CUB / raw __global__ / mixed]
- Libraries & roles: [...]
- Reference implementations: [repos + paths: vLLM, TRT-LLM, SGLang, flash-attention, flashinfer, triton, deepseek-ai, …]
- If raw kernel: [why]
