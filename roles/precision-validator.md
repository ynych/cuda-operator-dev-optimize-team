...
- 明示 **atol/rtol** 及理由
- **FP8 / 整型 / W4A16（AWQ·GPTQ 等）**：与部署或 TRT-LLM / vLLM / SGLang / FlashInfer / **Transformer Engine** / **llm-compressor 导出栈** / AutoAWQ / AutoGPTQ / DeepGEMM 等 **同一栈** 的 ref 绑定；不得单端用 fp32 强行收紧导致误杀
